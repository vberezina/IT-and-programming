...
7. 📊 [Структуры данных в Python: От списков до словарей](practices/PR6/PR6.ipynb)  
_(Массивы, кортежи, методы работы с коллекциями)_

8. 🔍 [Регулярные выражения: Поиск и обработка текста](practices/PR7/PR7.ipynb)  
_(Шаблоны, re-модуль, валидация данных)_

9. 🛡️ [Защита от дурака: Валидация пользовательского ввода](practices/PR8/PR8.ipynb)  
_(Проверка данных, обработка исключений, регулярные выражения)_

### [Вопросы к экзамену](exam1.md)
*** 
### [Методические указания по написанию научной статьи для студентов технических специальностей](recom_article.md)
